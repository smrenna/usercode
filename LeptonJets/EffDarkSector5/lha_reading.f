...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,3000004,bn,mhd0,100d0)
       call set_it(n,ivalue,value,name,3000005,bn,mhd1,100d0)
       call set_it(n,ivalue,value,name,3000006,bn,mhd2,100d0)
       call set_it(n,ivalue,value,name,3000007,bn,mhd3,100d0)
       call set_it(n,ivalue,value,name,3000008,bn,mhd4,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,3000004,bn,whd0,1d0)
       call set_it(n,ivalue,value,name,3000005,bn,whd1,1d0)
       call set_it(n,ivalue,value,name,3000006,bn,whd2,1d0)
       call set_it(n,ivalue,value,name,3000007,bn,whd3,1d0)
       call set_it(n,ivalue,value,name,3000008,bn,whd4,1d0)
       bn='mguser'
      return
      end
