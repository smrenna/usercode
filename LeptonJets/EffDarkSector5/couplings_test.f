...
c
 ...
 25   format( 1x,a10,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(1,11) 'GGH ', GGH(1),' ', GGH(2)
      write(1,20) 'GHDD1 ', GHDD1
      write(1,20) 'GHDD2 ', GHDD2
      write(1,20) 'GHDD3 ', GHDD3
      write(1,20) 'GHDD4 ', GHDD4
      write(1,20) 'GZZHD1 ', GZZHD1
      write(1,20) 'GD1D0 ', GD1D0
      write(1,20) 'GD1D2 ', GD1D2
      write(1,20) 'GD2D3 ', GD2D3
      write(1,20) 'GD3D4 ', GD3D4
