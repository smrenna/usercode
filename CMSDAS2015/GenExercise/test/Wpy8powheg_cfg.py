...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/cmsdas/2012/GenShortExercise/WplusToENu_M-20_CT10_TuneZ2_7TeV-powheg-pythia-0.root')
)
...
process.GEN = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('pythia8powheg.root')
)
